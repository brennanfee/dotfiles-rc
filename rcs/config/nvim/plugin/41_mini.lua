...
-- NOTE: I'm using Snacks.dashboard instead
...
-- USING Snacks.dashboard instead
-- now(function() require('mini.starter').setup() end)
now(function()
  -- Get a fortune (requires the fortune-mod OS package to be installed to work)
...
-- NOTE: I'm using Lualine instead
...
later(function()
  ...
  miniclue.setup({
    ...
    clues = {
      ...
      { mode = "n", keys = '<Leader>q', desc = '+Quickfix/Location Lists' },
      { mode = "n", keys = '<Leader>s', desc = '+Session' },
      { mode = "n", keys = '<Leader>t', desc = '+Terminal' },
      { mode = "n", keys = '<Leader>v', desc = '+Visits' },
      { mode = "n", keys = '<Leader>?', desc = '+Key Mappings' },

      { mode = "x", keys = '<Leader>g', desc = '+Git' },
      { mode = "x", keys = '<Leader>l', desc = '+LSP/Language' },
    },
...
-- NOTE: Not using the mini map at all
